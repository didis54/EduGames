...
class matterFrame():
    ...
    global gameLV1, gameLV2, extend, extendStat, name, openGame1, img, langFrameClose, openStatFrame
    ...
    def open(profilName):
        ...
        btMath = Button(mainFrame, text="Math", image=imgMath).place(x=10, y=10, width=64, height=64)
